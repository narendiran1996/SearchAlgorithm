...
def createStraightLineDistance(toNode):
    ...
    dicSTLineDistanceFromALLtoGoal['Erode'] = 242
    dicSTLineDistanceFromALLtoGoal['Karur'] = 220
    dicSTLineDistanceFromALLtoGoal['Nilgiris'] = 346
    dicSTLineDistanceFromALLtoGoal['Tiruppur'] = 280
    dicSTLineDistanceFromALLtoGoal['Namakkal'] = 190
    dicSTLineDistanceFromALLtoGoal['Trichy'] = 176
    dicSTLineDistanceFromALLtoGoal['Salem'] = 184
    dicSTLineDistanceFromALLtoGoal['Madurai'] = 291
    dicSTLineDistanceFromALLtoGoal['Pudukottai'] = 205
    dicSTLineDistanceFromALLtoGoal['Tanjavur'] = 148
    dicSTLineDistanceFromALLtoGoal['Ariyalur'] = 123
    dicSTLineDistanceFromALLtoGoal['Perambalur'] = 135
    dicSTLineDistanceFromALLtoGoal['Tiruvarur'] = 130
    dicSTLineDistanceFromALLtoGoal['Villupuram'] = 39
    dicSTLineDistanceFromALLtoGoal['Cuddalore'] = 20
    dicSTLineDistanceFromALLtoGoal['Dharmapuri'] = 179
    dicSTLineDistanceFromALLtoGoal['Chengalpattu'] = 94
    dicSTLineDistanceFromALLtoGoal['Nagapattinam'] = 125
    dicSTLineDistanceFromALLtoGoal['Pondicherry'] = 0
    dicSTLineDistanceFromALLtoGoal['Coimbatore'] = 328
    dicSTLineDistanceFromALLtoGoal['Tiruvannamalai'] = 88
dicDistanceFromSource = {}
dicDistanceFromSourceToGoal = {}
...
class MyPrioirtyQueue():
    ...
    def dequeue(self):
        ...
        for i in range(len(self.myQueue)):
            if dicDistanceFromSourceToGoal[self.myQueue[i]] < dicDistanceFromSourceToGoal[self.myQueue[minDistanceIndex]]:
                minDistanceIndex = i
...
def AStar(fromNode, toNode):
    createStraightLineDistance(toNode)
    if os.path.exists('../AStaroutput/'):
        import shutil
        shutil.rmtree('../AStaroutput/')
    os.makedirs('../AStaroutput/')
    global img, dicDistanceFromSource,dicDistanceFromSourceToGoal
    dicDistanceFromSource[fromNode] = 0
    dicDistanceFromSourceToGoal[fromNode] = dicSTLineDistanceFromALLtoGoal[fromNode]
...
print(AStar('Coimbatore', 'Pondicherry'))
print(dicDistanceFromSource)
# print(dicDistanceFromSourceToGoal["Coimbatore"])